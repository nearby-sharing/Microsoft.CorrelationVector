...
public abstract class CorrelationVector : ICorrelationVector
{
    ...
    {
        SpinParameters defaultParameters = new()
        {
    ...
    public static CorrelationVector Spin(string correlationVector, SpinParameters parameters)
    {
        ...
        {
            CorrelationVectorVersion.V1 => CorrelationVectorV1.Spin(correlationVector, parameters),
            CorrelationVectorVersion.V2 => CorrelationVectorV2.Spin(correlationVector, parameters),
            _ => null,
        };
    }
    ...
    public abstract (string newVector, string oldVector) Reset();
